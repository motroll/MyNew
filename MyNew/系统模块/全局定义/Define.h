...
#define LEN_PICTURE					128									//活动图片的长度
#define LEN_PRESENT					6									//活动赠送档次长度
...
#define US_SELECT					0x02								//选座状态
#define US_SIT						0x03								//坐下状态
#define US_READY					0x04								//同意状态
#define US_LOOKON					0x05								//旁观状态
#define US_PLAYING					0x06								//游戏状态
#define US_OFFLINE					0x07								//断线状态
#define US_WAIT					    0x08								//等待状态
