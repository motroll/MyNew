...
//、、	if(IniData.ReadRegeditString(TEXT("GameRegedit"),TEXT("ServiceRegedit"),NULL,DataBaseParameter.szDataBaseAddr,CountArray(DataBaseParameter.szDataBaseAddr)))
	{
		//连接信息
...
//	else
//	{
//		AfxMessageBox(_T("请购买正版联系QQ:120300163"));
//	}
	return true;
}
