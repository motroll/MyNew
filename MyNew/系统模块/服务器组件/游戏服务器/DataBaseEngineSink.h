...
private:
	// 查询充值列表，并充值
	bool OnCheckAllPayList(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
...
protected: 
	// 查询俱乐部信息
	bool  OnRequestClubInfo(DWORD  dwContenxtID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
	// 通过私人场方式加入俱乐部房间判断
	bool  OnRequestClubRomPrivate(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
	// 检查是否能进入俱乐部房间
	bool OnRequestClubCheckRoom(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
	// 创建楼层
	bool OnRequestCreateFloorStressReq(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
	// 更新俱乐部
	bool OnRequestUpdateClubFloor(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
};
