...
public:
	void SendPrivateRoom(int  iRoomId, bool bAddFlag);
	void SendPrivateClub(std::vector<CMD_CS_S_ServerRoom> vecServerRoom, int  iClubId, bool bAddFlag);
