...
protected:
	...
	bool OnSubHuanPai(const void * pBuffer, WORD wDataSize);
	bool OnSubXuanQueNotice(const void * pBuffer, WORD wDataSize);
	bool OnSubXuanQue(const void * pBuffer, WORD wDataSize);
	bool OnSubHuanPaiChengDu(const void * pBuffer, WORD wDataSize);

	bool OnSubHuanPaiAndriod(const void* pBuffer,WORD wDataSize);
	//处理函数
protected:
	//出牌
